...
Ce script effectue divers contrôles qualité pour garantir la cohérence, l’exactitude et

la normalisation des données dans la couche « Silver ». Il vérifie notamment :

- Les clés primaires nulles ou dupliquées.

- Les espaces indésirables dans les champs de type chaîne de caractères.

- La normalisation et la cohérence des données.
