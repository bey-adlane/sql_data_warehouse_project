...
et l’exactitude de la layer de référence. Ces contrôles garantissent :

- L’unicité des clés de substitution dans les tables de dimensions.

- L’intégrité référentielle entre les tables de faits et les tables de dimensions.

- La validation des relations dans le modèle de données.
